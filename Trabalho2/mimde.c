...
// tempo de atendimento = L/R = 1500 / 445,45 = 3,3674 segundos
    ...
    double tempos_medios_servicos[4][3] = {{0.7483, 0.05442, 2.0408}, {0.9977, 0.0726, 2.7211}, {1.0771, 0.0862, 3.2313}, {1.2347, 0.0898, 3.3674}};
    printf("tempos_medios_servicos[0][0] = %f");
    double e_n_final;
    double e_w_final;
    double lambda;
