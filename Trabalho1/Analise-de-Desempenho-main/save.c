    ...
    {   
        ...
        while (tempo_decorrido <= tempo_simulacao)
        {
            ...
            {   
                ...
                double erro_little = (e_n_final - lambda * e_w_final) < 0 ? (e_n_final - lambda * e_w_final) * -1 : (e_n_final - lambda * e_w_final);
                FILE *arq;
                arq = fopen("graficos.txt", "w");
                fprintf("%lf\t%lf\t%lf\t%lf\n", ocupacao, e_n_final, e_w_final, erro_little );*/
                coleta_dados += 100;
                e_n.tempo_anterior = tempo_decorrido;
                e_w_chegada.tempo_anterior = tempo_decorrido;
                e_w_saida.tempo_anterior = tempo_decorrido;
